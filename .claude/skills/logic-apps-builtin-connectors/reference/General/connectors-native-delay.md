<!-- Source: https://learn.microsoft.com/en-us/azure/connectors/connectors-native-delay -->
...
- Basic knowledge about [logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview). To use an action, your workflow must start with a trigger. You can use any trigger you want and add other actions before you add a delay action.
...
1. On the designer, follow these [general steps to add the action named **Delay**](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow.md#add-action) to your workflow.


1. In the **Delay** action, specify the amount of time to wait before the next action runs.

   ![Screenshot shows the Delay action where you can set the count and unit for the delay.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-native-delay/delay-time-intervals.png)
...
1. On the designer, follow these [general steps to add the action named **Delay until**](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow.md#add-action) to your workflow.


1. In the **Delay until** action, provide the date and time for when you want to resume the workflow.

   ![Screenshot shows the action named Delay until and the timestamp for when to end the delay.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-native-delay/delay-until-timestamp.png)
