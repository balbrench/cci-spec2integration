<!-- Source: https://learn.microsoft.com/en-us/azure/connectors/connectors-native-webhook -->
...
For example, the Office 365 Outlook connector's [**Send approval email**](https://learn.microsoft.com/en-us/azure/connectors/connectors-create-api-office365-outlook) action is an example of a webhook action that follows this pattern. You can extend this pattern into any service by using the webhook action.

For more information, see the following documentation:

* [Webhooks and subscriptions](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-workflow-actions-triggers.md#webhooks-and-subscriptions)
* [Create custom APIs that support a webhook](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-create-api-app)

For information about encryption, security, and authorization for inbound calls to your logic app, such as [Transport Layer Security (TLS)](https://en.wikipedia.org/wiki/Transport_Layer_Security) or [Microsoft Entra ID Open Authentication](https://learn.microsoft.com/en-us/azure/active-directory/develop/index.yml), see [Access for inbound calls to request-based triggers](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-securing-a-logic-app.md#secure-inbound-requests).

## Connector technical reference

For more information about trigger and action parameters, see [HTTP Webhook parameters](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-workflow-actions-triggers.md#http-webhook-trigger).

## Prerequisites

* An Azure account and subscription. If you don't have an Azure subscription, [sign up for a free Azure account](https://azure.microsoft.com/pricing/purchase-options/azure-account?cid=msft_learn).

* The URL for an already deployed endpoint or API that supports the webhook subscribe and unsubscribe pattern for [webhook triggers in workflows](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-create-api-app.md#webhook-triggers) or [webhook actions in workflows](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-create-api-app.md#webhook-actions), as appropriate.
...
1. Add the **HTTP Webhook** trigger to your workflow by following the [general steps to add a trigger](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow.md?tabs=standard#add-trigger).
...
1. Provide the values for the [HTTP Webhook trigger parameters](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-workflow-actions-triggers.md#http-webhook-trigger) that you want to use for the subscribe and unsubscribe calls.
   ...
   ![Screenshot shows Standard workflow with HTTP Webhook trigger parameters.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-native-webhook/webhook-trigger-parameters-standard.png)

   If you need to use authentication, you can add the **Subscribe Authentication** and **Unsubscribe Authentication** properties. For more information about authentication types available for **HTTP Webhook**, see [Add authentication to outbound calls](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-securing-a-logic-app.md#add-authentication-outbound).
...
1. Add the **HTTP Webhook** trigger to your workflow by following the [general steps to add a trigger](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow.md?tabs=consumption#add-trigger).
...
1. Provide the values for the [HTTP Webhook trigger parameters](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-workflow-actions-triggers.md#http-webhook-trigger) that you want to use for the subscribe and unsubscribe calls.
   ...
   ![Screenshot shows Consumption workflow with HTTP Webhook trigger parameters.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-native-webhook/webhook-trigger-parameters-consumption.png)

1. To add other trigger properties, open the **Advanced parameters** list.

   ![Screenshot shows Consumption workflow with HTTP Webhook trigger and more properties.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-native-webhook/webhook-trigger-add-properties-consumption.png)

   For example, if you need to use authentication, you can add the **Subscribe Authentication** and **Unsubscribe Authentication** properties. For more information about authentication types available for **HTTP Webhook**, see [Add authentication to outbound calls](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-securing-a-logic-app.md#add-authentication-outbound).
...
1. Add the **HTTP Webhook** action to your workflow by following the [general steps to add a action](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow.md?tabs=standard#add-action).

   This example renames the action to **HTTP Webhook action** so that the step has a more descriptive name.

1. Provide the values for the **HTTP Webhook** action parameters, which are similar to the [HTTP Webhook trigger parameters](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-workflow-actions-triggers.md#http-webhook-trigger), that you want to use for the subscribe and unsubscribe calls.
   ...
   ![Screenshot shows Standard workflow with HTTP Webhook action parameters.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-native-webhook/webhook-action-parameters-standard.png)
...
1. Add the **HTTP Webhook** action to your workflow by following the [general steps to add an action](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow.md?tabs=consumption#add-action).
...
1. Provide the values for the **HTTP Webhook** action parameters, which are similar to the [HTTP Webhook trigger parameters](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-workflow-actions-triggers.md#http-webhook-trigger), that you want to use for the subscribe and unsubscribe calls.
   ...
   ![Screenshot shows Consumption workflow with HTTP Webhook action parameters.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-native-webhook/webhook-action-parameters-consumption.png)

1. To add other action properties, open the **Advanced parameters** list.

   ![Screenshot shows Consumption workflow with HTTP Webhook action and more properties.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/connectors/media/connectors-native-webhook/webhook-action-add-properties-consumption.png)
...
* [Access for inbound calls to request-based triggers](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-securing-a-logic-app.md#secure-inbound-requests)
* [List of all Logic Apps connectors](https://learn.microsoft.com/en-us/connectors/connector-reference/connector-reference-logicapps-connectors)
