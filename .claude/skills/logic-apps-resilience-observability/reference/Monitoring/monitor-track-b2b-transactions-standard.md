<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/monitor-track-b2b-transactions-standard -->
...
![Screenshot shows Azure portal, Premium integration account, and B2B tracking dashboard.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/monitor-track-b2b-transactions/dashboard-example-overview.png)
...
- A Premium-level integration account. If you don't have this integration account, see [Create and manage integration accounts for B2B workflows in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/enterprise-integration/create-integration-account).
...
- An Azure Data Explorer cluster and database to store transaction logs and tracking data.
  ...
  If you don't have an existing cluster and database, see [Quickstart: Create an Azure Data Explorer cluster and database](https://learn.microsoft.com/en-us/azure/data-explorer/create-cluster-and-database) and [What is Azure Data Explorer](https://learn.microsoft.com/en-us/azure/data-explorer/data-explorer-overview).
...
1. On the toolbar, select **Add**. On the **Add tracking store** pane, provide the following information:
   ...
   ![Screenshot shows Azure portal, Premium integration account menu with selected item named Tracking stores, toolbar with selected option for Add, and open pane for Add tracking store.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/monitor-track-b2b-transactions/add-tracking-store.png)
...
- [Add agreements between partners in integration accounts](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-agreements)
- [Add trading partners to integration accounts](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-partners)
...
1. On your integration account menu, under **Monitoring**, select **B2B tracking**, which opens the dashboard.
   ...
   ![Screenshot shows Azure portal, Premium integration account, B2B tracking dashboard, and selected Overview tab.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/monitor-track-b2b-transactions/dashboard-example-overview.png)
...
1. To view the details for the collected messages, select the **AS2** or **X12** tab.
   ...
   ![Screenshot shows Premium integration account with B2B tracking selected, and a table with details about collected X12 messages.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/monitor-track-b2b-transactions/example-x12-message-details.png)
...
> in your Azure Data Explorer database using specific [JSON schemas for tracking B2B transactions](https://learn.microsoft.com/en-us/azure/logic-apps/tracking-schemas-standard). 
...
> Azure Data Explorer database using specific [JSON schemas for tracking B2B transactions](https://learn.microsoft.com/en-us/azure/logic-apps/tracking-schemas-standard). 
> Your database must also grant **Ingester** permissions to your integration account resource.
...
- [Schemas for tracking B2B transactions - Standard workflows](https://learn.microsoft.com/en-us/azure/logic-apps/tracking-schemas-standard)
