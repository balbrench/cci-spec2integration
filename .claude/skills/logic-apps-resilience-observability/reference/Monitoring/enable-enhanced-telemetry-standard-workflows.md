<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/enable-enhanced-telemetry-standard-workflows -->
...
With your logic app connected to Application Insights, you can view log data and other metrics in near real time through the Azure portal by using [Live Metrics Stream](https://learn.microsoft.com/en-us/azure/azure-monitor/app/live-stream). You also have visualizations to help you plot incoming requests, outgoing requests, and overall health and access to a table of trace level diagnostics.
...
- An [Application Insights](https://learn.microsoft.com/en-us/azure/azure-monitor/app/app-insights-overview) instance. You create this resource [in advance](https://learn.microsoft.com/en-us/azure/azure-monitor/app/create-workspace-resource), when you create your Standard logic app, or after logic app deployment.
...
- A Standard logic app and workflow, either in the Azure portal or in Visual Studio Code.
  ...
  - Your logic app must [have enabled Application Insights](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal#enable-open-application-insights) for diagnostics logging and tracing. You can do so either when you create your logic app or after deployment.
...
1. On the **Edit a container** pane, select **Environment variables**, and then select **Add** so you can add the following app settings:
   ...
   ![Screenshot shows Azure portal, Logic App (Hybrid) resource menu with selected Settings, Containers, Edit and deploy, and pane named Environment variables.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/hybrid-app-settings.png)
...
For more information, see [Edit host and app settings for Standard logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/edit-app-settings-host-settings).
...
![Screenshot shows Azure portal and Standard workflow designer with trigger and actions.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/workflow-overview.png)
...
![Screenshot shows Azure portal, Standard workflow, Request trigger selected, Settings tab, and custom tracking Id.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/request-trigger-custom-tracking-id.png)
...
![Screenshot shows Azure portal, Standard workflow, Compose action selected, Settings tab, and tracked property.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/compose-action-tracked-property.png)
...
1. To view all trigger and action events, create and run the following query:
   ...
   ![Screenshot shows Application Insights, query, Results tab, and operation events from workflow run.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/results-table.png)
...
1. To view the details for a specific operation, expand the row for the trigger or action:
   ...
   ![Screenshot shows Application Insights, Results tab for Request trigger, and details.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/request-trigger-details.png)
   ...
   ![Screenshot shows Application Insights, Results tab for Compose action, and details.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/compose-action-details.png)
...
1. To view all trigger events in a specific workflow, create and run a query with the **customDimensions.Category** property value set to **Workflow.Operations.Triggers** and **operation_Name** set to the workflow name, for example:
   ...
   ![Screenshot shows Requests table query for triggers only.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/triggers-only.png)
...
1. To view all action events in a specific workflow, create a query with the **customDimensions.Category** property value set to **Workflow.Operations.Actions** and **operation_Name** set to the workflow name, for example:
   ...
   ![Screenshot shows Requests table query for actions only.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/actions-only.png)
...
1. To view all operation events with a specific trigger type, create and run a query with the **customDimensions.triggerType** value set to the trigger type you want, for example:
   ...
   ![Screenshot shows Requests table query for Request trigger type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/trigger-type.png)
...
1. To view all operation events with a specific action type, create and run a query with the **customDimensions.actionType** value set to the action type you want, for example:
   ...
   ![Screenshot shows Requests table query for Compose action type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/action-type.png)
...
1. To view all operation events with a specific workflow run ID, create and run a query with the **operation_Id** value set to the workflow run ID, for example:
   ...
   ![Screenshot shows Requests table query based on workflow run ID.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/workflow-run-id.png)
...
1. To view all operation events with a specific client tracking ID in a specific workflow, create and run a query with the **operation_Name** value set to the workflow name and the **clientTrackingId** property value set to the value you want, for example:
   ...
   ![Screenshot shows query results using operation name and client tracking ID.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/query-operation-name-client-tracking-id.png)
...
1. To view all operation events with a specific client tracking ID in a specific workflow, create and run a query with the **operation_Name** value set to the workflow name and the **solutionName** property value set to the value you want, for example:
   ...
   ![Screenshot shows query results using operation name and solution name.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/query-operation-name-solution-name.png)
...
![Screenshot shows Azure portal, Standard workflow, HTTP action selected, Settings tab, and retry policy.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/http-action-retry-policy.png)
...
1. To view the retry attempts for a specific operation with a retry policy, expand the row for that operation.
   ...
   ![Screenshot shows Application Insights, Results tab for HTTP action, and details.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/http-action-retry-details.png)
...
1. To view all trigger events using a specific connector type, create and run a query with the following properties and values:
   ...
   ![Screenshot shows Application Insights, Results tab for Microsoft Dataverse trigger events with ApiConnectionWebhook connection.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/apiconnectionwebhook-connection.png)
...
1. To view all action events with specific connector usage, create and run a query with the **customDimensions.Category** value set to **Workflow.Operations.Actions**, the **customDimensions.triggerType** value set to the operation type, and the **customDimensions.apiName** set to the connector's API name in JSON format, for example:
   ...
   ![Screenshot shows Application Insights, Results tab for Microsoft Office 365 Outlook action events with ApiConnection connection.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table/apiconnection-connection.png)
...
1. Create and run a query with the **customDimensions.Category** value set to **Workflow.Operations.Runs**, for example:
   ...
   ![Screenshot shows Application Insights, Results tab for start and events across all workflow runs.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/traces-table/start-end-events-all-runs.png)
...
1. Create and run a query with the **customDimensions.Category** value set to **Workflow.Operations.Runs** and the **operation_Id** value set to the workflow run ID, for example:
   ...
   ![Screenshot shows Application Insights, Results tab for start and events for a specific run.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/traces-table/start-end-events-specific-run.png)
...
1. Create and run a query with the **customDimensions.Category** value set to **Workflow.Operations.Runs** and the **operation_Id** value set to the workflow run ID, for example:
   ...
   ![Screenshot shows Application Insights, Results tab for batch send and batch receive events in all workflow runs.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/traces-table/batch-events-all-runs.png)
...
![Screenshot shows Azure portal, Standard workflow designer, Request trigger, Compose action with an exception-generating expression, and Response action.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/exceptions-table/compose-action-exception-expression.png)
...
1. To view the details for a specific exception, expand the row for that exception:
   ...
   ![Screenshot shows Application Insights, Results tab for exception events with the exception event for the Compose action expanded, and exception details.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/exceptions-table/exception-details.png)
...
![Screenshot shows Azure portal, Standard workflow designer with parent workflow using HTTP action to call a child workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/dependencies-table/parent-child-workflow.png)
...
1. To view dependency events between the parent workflow and the child workflow, create and run the following query:
   ...
   This query uses the [**union** operator](https://learn.microsoft.com/en-us/azure/data-explorer/kusto/query/unionoperator) to return records from the Requests table and Dependencies table. The query also uses the **operation_Id** property value to provide the link between records by specifying the workflow **runId** value you want, for example:
   ...
   ![Screenshot shows Application Insights, Results tab with dependency events for a specific workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/dependencies-table/dependency-details.png)
...
![Screenshot shows Application Insights and application map with dependency between parent workflow and child workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/dependencies-table/application-map.png)
...
![Screenshot shows Application Insights with Requests table and record for a Batch messages trigger event.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/requests-table-batch-trigger-event.png)
...
If you don't specify any **logLevel** values, the default verbosity level is **Information**. For more information, see [Configure log levels](https://learn.microsoft.com/en-us/azure/azure-functions/configure-monitoring.md#configure-log-levels).
...
1. From the **Aggregation** list, select a type, for example, **Count** or **Avg**.
   ...
   ![Screenshot shows Application Insights with Metrics dashboard and chart that shows number of finished workflow executions over time.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/metrics-dashboard.png)
...
1. On your Application Insights resource, [enable multidimensional metrics](https://learn.microsoft.com/en-us/azure/azure-monitor/app/get-metric#enable-multidimensional-metrics).
...
1. From the **Values** list, select the workflows you want.
   ...
   ![Screenshot shows Application Insights with Metrics dashboard and chart with multidimensional metrics.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/multidimensional-metrics.png)
...
1. On your Application Insights resource menu, under **Investigate**, select **Live metrics**.
   ...
   ![Screenshot shows Azure portal and Application Insights menu with selected item named Live metrics.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/live-metrics.png)

For more information, see [Live Metrics: Monitor and diagnose with 1-second latency](https://learn.microsoft.com/en-us/azure/azure-monitor/app/live-stream).
...
1. On your logic app resource menu, under **Monitoring**, select **Log stream**.
   ...
   ![Screenshot shows Azure portal and Standard logic app menu with selected item named Log stream.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/enable-enhanced-telemetry-standard-workflows/log-stream.png)

## Next steps

[Enable or open Application Insights](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-azure-portal#enable-open-application-insights)
