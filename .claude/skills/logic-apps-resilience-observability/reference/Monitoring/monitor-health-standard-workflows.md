<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/monitor-health-standard-workflows -->
...
![Screenshot shows Standard logic app workflow to use as the health workflow.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/monitor-health-standard-workflows/health-workflow.png)
...
- Changes in the specified path for Health Check cause your logic app to restart. To reduce the impact on production apps, [set up and use deployment slots](https://learn.microsoft.com/en-us/azure/logic-apps/set-up-deployment-slots).
...
1. On the logic app menu, under **Monitoring**, select **Health check**. On the **Health check** page, on the **Health check** tab, select **Enable**.
   ...
   ![Screenshot shows Azure portal, page for Health check, and selected option for Enable.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/monitor-health-standard-workflows/health-check.png)
...
1. Under **Troubleshooting categories**, select **Availability and Performance**.
   ...
   ![Screenshot shows Azure portal, page for Diagnose and solve problems, and selected option for Availability and Performance.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/monitor-health-standard-workflows/availability-performance.png)
...
1. If your workflow starts with a [service provider-based trigger](https://learn.microsoft.com/en-us/azure/connectors/built-in#service-provider-based-built-in-connectors), make sure that the trigger successfully works as expected.
