<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-as2 -->
...
- If you use [Azure Key Vault](https://learn.microsoft.com/en-us/azure/key-vault/general/overview) for certificate management, check that your vault keys permit the **Encrypt** and **Decrypt** operations. Otherwise, the encoding and decoding actions fail.
  ...
  1. On the **Key Version** page, under **Permitted operations**, confirm that **Encrypt** and **Decrypt** are selected.
     ...
     ![Screenshot shows the Azure portal and key vault resource with the key and key version pages open and the selected Encrypt and Decrypt operations.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-as2/key-vault-permitted-operations.png)
...
1. In the designer, follow these [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-action) to add the AS2 (v2) action named **AS2 Encode** to your workflow.
...
1. In the action information pane, provide the following information:
   ...
   ![Screenshot shows the workflow designer and AS2 Encode action with the message encoding properties.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-as2/encode-details.png)
...
1. In the designer, follow these [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-action) to add the AS2 action named **Encode to AS2 message** to your workflow.
...
1. When prompted to create a connection to your integration account, provide the following information:
   ...
   ![Screenshot shows Encode to AS2 message connection information.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-as2/create-encode-connection.png)
...
1. In the action information pane, provide the following information.
   ...
   ![Screenshot shows the Encode to AS2 message action with the message encoding properties.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-as2/encode-message-details.png)
...
1. In the designer, follow these [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-action) to add the AS2 (v2) action named **AS2 Decode** to your workflow.
...
1. In the action information pane, provide the following information:
   ...
   ![Screenshot shows the workflow designer and AS2 Decode action with the message decoding properties.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-as2/decode-details.png)
...
1. In the designer, follow these [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/create-workflow-with-trigger-or-action#add-action) to add the AS2 action named **Decode AS2 message** to your workflow.
...
1. When prompted to create a connection to your integration account, provide the following information:
   ...
   ![Screenshot shows Decode AS2 message connection information.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-as2/create-decode-connection.png)
...
1. In the action information pane, provide the following values:
   ...
   ![Screenshot shows the Decode AS2 message action with the Body entered from the Request trigger.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-as2/decode-message-details.png)
