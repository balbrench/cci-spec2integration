<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-transform -->
...
In enterprise integration business-to-business (B2B) scenarios, you might have to convert XML between formats. Your logic app workflow can transform XML by using the **Transform XML** action and a predefined [*map*](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-maps).
...
* An [integration account resource](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-create-integration-account) where you define and store artifacts, such as trading partners, agreements, certificates, and so on, for use in your enterprise integration and B2B workflows. This resource has to meet the following requirements:
  ...
  * If you're working on a [Consumption logic app resource and workflow](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview#resource-environment-differences), your integration account requires the following items:

    * The [map](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-maps) to use for transforming XML content.

    * A [link to your logic app resource](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-create-integration-account#link-account).

  * If you're working on a [Standard logic app resource and workflow](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview#resource-environment-differences), you can link your integration account to your logic app resource, upload maps directly to your logic app resource, or both, based on the following scenarios: 
    ...
    * If you don't have an integration account or only plan to use your artifacts across multiple workflows within the *same logic app resource*, you can [directly add maps to your logic app resource](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-maps) using either the Azure portal or Visual Studio Code.
...
1. In the **Content** box, specify the XML content that you want to transform using any XML data that you receive in the HTTP request.
   ...
   1. From the dynamic content list, select the token for the content that you want to transform.
      ...
      ![Screenshot shows Standard workflow with opened dynamic content list.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-transform/open-dynamic-content-list-standard.png)
...
1. In the **Content** box, specify the XML content that you want to transform using any XML data that you receive in the HTTP request.
   ...
   ![Screenshot shows Consumption workflow with opened dynamic content list and cursor in Content box.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-transform/open-dynamic-content-list-consumption.png)
...
The **Transform XML** action supports referencing external assemblies from maps, which enable directly calling custom .NET code from XSLT maps. For more information, see [Add XSLT maps for workflows in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-maps).
...
1. In the **XML Extension Object** box, specify your extension object, for example:
   ...
   ![Screenshot shows Transform XML action with XML Extension Object parameter and value.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-transform/xml-extension-object-standard.png)
...
* [Add XSLT maps for XML transformation in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-maps)
