<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-x12-message-settings -->
...
This reference describes the properties that you can set in an X12 agreement for specifying how to handle messages between [trading partners](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-partners). Set up these properties based on your agreement with the partner that exchanges messages with you.

<a name="x12-inbound-messages"></a>

## X12 Receive Settings

![Screenshot showing Azure portal and X12 agreement settings for inbound messages.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-x12-message-settings/x12-receive-settings.png)
...
![Screenshot showing Azure portal and X12 agreement settings for outbound messages.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-x12-message-settings/x12-send-settings.png)
...
For this section, select a [schema](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-schemas) from your [integration account](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-create-integration-account) for each interchange. After you complete each row, a new empty row automatically appears.
...
1. In your HIPAA schema, replace the current message type with the variant message type for the document version number that you want to use.
   ...
   1. In the Azure portal, go to your integration account. Find and download your schema. Replace the message type and rename the schema file, and upload your revised schema to your integration account. For more information, see [Edit a schema](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-schemas#edit-schema).
...
1. In your agreement's message settings, disable EDI validation by clearing the **EDI Validation** checkbox either for each message type or for all message types if you're using the **Default** values.
   ...
   ![Screenshot shows X12 agreement settings to disable validation for all message types or each message type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-x12-message-settings/x12-disable-validation.png) 
