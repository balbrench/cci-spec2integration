<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-liquid-transform -->
...
* [Consumption versus Standard logic apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-overview#resource-environment-differences)
* [Business-to-business (B2B) built-in operations](https://learn.microsoft.com/en-us/azure/connectors/built-in.md#b2b-built-in-operations)
* [About built-in connectors in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/connectors/built-in)
* [About managed connectors in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/connectors/managed) and [Managed connectors for Azure Logic Apps](https://learn.microsoft.com/en-us/connectors/connector-reference/connector-reference-logicapps-connectors)
...
* An [integration account resource](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-create-integration-account). Usually, you need this resource when you want to define and store artifacts for use in enterprise integration and B2B workflows.
...
1. In the Azure portal search box, enter **integration accounts**, and select **Integration accounts**.
   ...
   ![Screenshot showing the Azure portal search box with integration accounts entered and integration accounts selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/find-integration-accounts.png)

1. Find and select your integration account.

   ![Screenshot showing integration accounts pane with integration account selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-integration-account.png)

1. On the integration account's navigation menu, under **Settings**, select **Maps**.

    ![Screenshot showing integration account navigation menu with Maps selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-maps.png)
...
1. On the **Maps** pane, select **Add**. Provide the following information about your map:
   ...
   | **Map** | SimpleJsonToJsonTemplate.liquid | An existing Liquid template or map file to use for transformation, which is *SimpleJsonToJsonTemplate.liquid* in this example. To find this file, you can use the file picker. For map size limits, see [Limits and configuration](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-limits-and-config.md#artifact-capacity-limits). |

   ![Screenshot showing Add Map pane with new template uploaded.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/add-liquid-template.png)
...
1. From the actions list, select the **Liquid** action that you want to use.
   ...
   ![Screenshot showing Consumption workflow designer with a Liquid action selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-liquid-action-consumption.png)
...
1. In the action's **Content** property, provide the JSON output from the trigger or a previous action that you want to transform by following these steps.
   ...
   1. From the dynamic content list, select the JSON data that you want to transform.
      ...
      ![Screenshot showing Consumption workflow, Liquid action's Content property, an open dynamic content list, and Body token selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-body-consumption.png)

1. From the **Map** list, select your Liquid template.

   This example continues with the template named **JsonToJsonTemplate**.

   ![Screenshot showing Consumption workflow, Liquid action's Map property, and the selected template.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-map-to-use-consumption.png)
...
1. In the search box, enter **liquid**. From the actions list, select the Liquid action that you want to use.
   ...
   ![Screenshot showing Standard workflow with a Liquid action selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-liquid-action-standard.png)
...
1. In the action's **Content** property, provide the JSON output from the trigger or a previous action that you want to transform by following these steps.
   ...
   1. From the dynamic content list, select the JSON data that you want to transform.
      ...
      ![Screenshot showing Standard workflow, Liquid action's Content property with dynamic content list opened, and Body token selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-body-standard.png)
...
1. From the **Source** list, select either **LogicApp** or **IntegrationAccount** as your Liquid template source.
   ...
   ![Screenshot showing Standard workflow with Source property and IntegrationAccount selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-logic-app-integration-account.png)

1. From the **Name** list, select your Liquid template.

   This example continues with the template named **JsonToJsonTemplate**.

   ![Screenshot showing Standard workflow and selected template.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/select-map-to-use-standard.png)
...
1. After your workflow finishes running, go to the workflow's run history, and examine the **Transform JSON to JSON** action's inputs and outputs, for example:
   ...
   ![Screenshot showing example output.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/example-output-jsontojson.png)
...
![Screenshot showing example output for JSON to text transformation.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/example-output-jsontotext.png)
...
![Screenshot showing example output for XML to JSON transformation.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/example-output-xmltojson.png)
...
![Screenshot showing example output for XML to text transformation](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-liquid-transform/example-output-xmltotext.png)
...
* [Add maps for transformations in workflows](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-maps)
