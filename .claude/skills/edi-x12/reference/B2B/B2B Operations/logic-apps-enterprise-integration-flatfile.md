<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-flatfile -->
...
For more information, see [Integration account built-in connectors](https://learn.microsoft.com/en-us/azure/connectors/built-in.md#b2b-built-in-operations).
...
- A flat file schema that specifies how to encode or decode XML content.
  ...
  For more information, see [Add schemas to integration accounts](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-schemas).
...
1. In the designer, open your workflow.
   ...
   This example uses the **Request** trigger named **When an HTTP request is received**. To add a trigger, see [Add a trigger to start your workflow](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow#add-trigger).

1. In the designer, follow these [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow#add-action) to add the built-in action named **Flat File Encoding**.
...
1. In the action's **Content** parameter, provide the XML content to encode, which is either output from the trigger or from a previous action, by following these steps:
   ...
   ![Screenshot shows the Azure portal, workflow designer, Flat File Encoding action, and Content parameter with dynamic content list and content selected for encoding.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-flatfile/select-content-to-encode.png)
...
1. From the **Schema Name** list, select your schema.
   ...
   ![Screenshot shows the designer and opened Schema Name list with selected schema for encoding.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-flatfile/select-encoding-schema.png)
...
1. In the designer, follow these [general steps](https://learn.microsoft.com/en-us/azure/logic-apps/add-trigger-action-workflow#add-action) to add the built-in action named **Flat File Decoding**.
...
1. In the action's **Content** parameter, provide the XML content to decode, either as output from the trigger or from a previous action by following these steps:
   ...
   ![Screenshot shows the Azure portal, workflow designer, Flat File Decoding action, and Content parameter with dynamic content list and content selected for decoding.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-flatfile/select-content-to-decode.png)
...
1. From the **Schema Name** list, select your schema.
   ...
   ![Screenshot shows the designer and opened Schema Name list with selected schema for decoding.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-flatfile/select-decoding-schema.png)
...
- [Process XML messages and flat files in Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-xml)
