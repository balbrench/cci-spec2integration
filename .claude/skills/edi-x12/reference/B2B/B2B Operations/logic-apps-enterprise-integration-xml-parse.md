<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-xml-parse -->
...
1. In the **Content** box, specify the XML content that you want to parse using any XML data that you receive in the HTTP request.
   ...
   1. From the dynamic content list, select the token for the content that you want to parse.
      ...
      ![Screenshot shows Standard workflow with opened dynamic content list.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/logic-apps-enterprise-integration-xml-parse/open-dynamic-content-list-standard.png)
...
- [Compose XML with schema](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-xml-compose)
