<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/create-maps-data-transformation-visual-studio-code -->
<!-- Title: Create maps for data transformation -->

# Create maps to transform data in logic app workflows with Visual Studio Code

[Include](https://learn.microsoft.com/en-us/azure/includes/logic-apps-sku-standard.md)
...
- To call maps created with Data Mapper, you can only use the **Data Mapper Operations** action named **Transform using Data Mapper XSLT**. [For maps created by any other tool, use the **XML Operations** action named **Transform XML**](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-transform).
...
- [Visual Studio Code and the Azure Logic Apps (Standard) extension](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-visual-studio-code#prerequisites) to create Standard logic app workflows.
...
- A Standard logic app project that includes a stateful or stateless workflow with a trigger at minimum. If you don't have a project, follow these steps in Visual Studio Code:
  ...
  1. [Connect to your Azure account](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-visual-studio-code#connect-azure-account), if you haven't already.

  1. [Create a local folder, a Standard logic app workspace and project, and a stateful or stateless workflow](https://learn.microsoft.com/en-us/azure/logic-apps/create-single-tenant-workflows-visual-studio-code#create-project). During workflow creation, select **Open in current window**.
...
1. In the **Azure** window, under **Data Mapper**, select **Create data map**.
   ...
   ![Screenshot shows Visual Studio Code with Azure window and selected button for Create data map.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/create-data-map.png)
...
1. In the prompt box, enter a name for the map.
   ...
   ![Screenshot shows prompt box and example data map name.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/data-map-name.png)
...
1. Choose your source and target schemas by following these steps:
   ...
   1. In the **Source** pane, select **Add new** > **Browse** to find and upload your source schema.
      ...
      ![Screenshot shows Data Mapper and Source pane with selected options for Add new and Browse.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/add-source-schema.png)
      ...
      ![Screenshot shows Source pane populated with source schema XML element nodes.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/added-source-schema.png)

   1. In the **Destination** pane, select **Add new** > **Browse** to find and upload your target schema.

      ![Screenshot shows Data Mapper and Destination pane with selected options for Add new and Browse.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/add-target-schema.png)
      ...
      ![Screenshot shows Destination pane populated with source schema XML element nodes.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/added-target-schema.png)
...
|--------|------|-----------|
| ![Icon representing an Array data type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/complex-array-icon.png) | Complex (Array) | Contains items or repeating item nodes. <br><br>An array element also displays the following connection point: <br><br> ![Icon for array element connection point.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/array-connection-point.png) |
| ![Icon representing a Bool data type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/bool-icon.png) | Bool | True or false only |
| ![Icon representing a Complex data type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/complex-icon.png) | Complex | An XML object with children properties, similar to the Object JSON type |
| ![Icon representing a DateTime data type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/datetime-icon.png) | DateTime | |
| ![Icon representing a Decimal data type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/decimal-icon.png) | Decimal | |
| ![Icon representing an Integer data type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/integer-icon.png) | Integer | Whole numbers only |
| ![Icon representing a String data type.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/string-icon.png) | String | |
...
1. Move your mouse pointer over the circle next to the source element name until the pointer changes to a plus sign (**+**).
   ...
   ![Screenshot shows Data Mapper with pointer over the source element.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/direct-mapping-start-source-element.png)
...
1. Drag and draw a line so that the source element connects to the circle for the target element in the **Destination** pane.
   ...
   ![Screenshot shows Data Mapper, a pointer over the target element, and a line between the source and target elements.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/direct-mapping-target-element.png)

   You've now created a direct mapping between both elements that have the same data types.

   ![Screenshot shows a complete mapping between the EmployeeID and ID in the source and target schemas, respectively.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/direct-mapping-complete.png)

   The **Code** pane shows the mapping relationship that you created:

   ![Screenshot shows Code pane  with direct mapping between EmployeeID and ID in the source and target schemas, respectively.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/direct-mapping-example-code-view.png)
   ...
   >
   > ![Screenshot shows mapping between mismatched data types.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/data-type-mismatch.png)
...
![](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/example-function.png)
...
1. In the **Functions** list, find and select the function that you want to use, which adds the function to the mapper surface. If the **Functions** list is collapsed, in the mapper's upper left corner, select the function icon (![Icon for Functions list.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/function-icon.png)).
   ...
   >
   > ![](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/disconnected-function-to-date.png)
...
1. Connect the function to the source and target elements.
   ...
   1. Drag and draw a line between the source element and the circle on the function's left edge. You can start from either the source element or the function.
      ...
      ![Screenshot shows mapping between a source element and a function.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/connect-function-to-date-start.png)
   ...
   1. Drag and draw a line between the function's right edge and the target element. You can start from either from the target element or the function.
      ...
      ![Screenshot shows mapping between function and target element.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/connect-function-to-date-end.png)

   The **Code** pane shows the mapping relationship that you created:

   ![Screenshot shows Code pane with direct mapping relationship between source and target elements.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/to-date-example-code-view.png)
...
1. On the **Input** tab, confirm or edit the input to use.
   ...
   ![Screenshot shows Input tab for the function named To Date.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/function-to-date-confirm-inputs.png)
...
1. In the **Functions** list, find and select the function that you want to use, which adds the function to the mapper surface.
   ...
   If the **Functions** list is collapsed, in the mapper's upper left corner, select the function icon (![Icon for Functions list.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/function-icon.png)).

   This example selects the **Concat** function, which is in the **String** function group.

   ![Screenshot shows the selected function named Concat.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/select-function-concat.png)
   ...
   > map, the function appears but isn't connected to any elements or other functions, for example:
   >
   > ![](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/disconnected-function-concat.png)
...
1. On the **Input** tab, select the source schema elements to use as the inputs.
   ...
   ![Screenshot shows multiple source elements as function inputs.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/function-multiple-inputs.png)
...
1. To complete the mapping, drag and draw a line between the function's right edge and the target element. You can start from either the target element or the function.
   ...
   ![Screenshot shows finished mappings between multiple inputs, Concat function, and target element.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/function-multiple-inputs-single-output.png)

   The **Code** pane shows the mapping relationships that you created:

   ![Screenshot shows Code pane with Concat function, which has multiple inputs and a single output.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/concat-example-code-view.png)
...
1. Drag and draw a line between the pair of array items. You can start from either the **Source** pane or the **Destination** pane.
   ...
   ![Screenshot shows mapper surface and drawing a mapping between the Name items in the source Employee and target Person arrays.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/loop-example-map-array-items.png)

   After you finish mapping the first pair of array items, the mapper automatically adds a loop between the source and target array parent elements, which have the following connection point type: ![Icon for array element completed connection point.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/array-connection-point-complete.png)
   ...
   ![Screenshot shows loop mapping between source Employee and target Person parent arrays.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/loop-example-automap-arrays.png)

   The **Code** pane shows the mapping and loop that you created:

   ![Screenshot shows Code pane  with loop mapping between source and target parent arrays plus array items.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/loop-example-code-view.png)

1. Continue mapping the other array elements, for example:

   ![Screenshot shows more mappings between other array items in source and target arrays.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/loop-example-continue-mapping.png)
...
1. In the **Source** and **Destination** panes, find the elements to map in your scenario.
   ...
   - **Destination** pane: **ItemPrice**, **ItemQuantity**, and **ItemDiscount**
     ...
     ![Screenshot shows mapper surface and data elements for example condition scenario.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/condition-example-elements.png)
...
1. In the **Functions** list, find and select the functions that you want to use, which adds the functions to the mapper surface.
   ...
   - If the **Functions** list is collapsed, in the mapper's upper left corner, select the function icon (![Icon for Functions pane.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/function-icon.png)).
   ...
   ![Screenshot shows mapper surface, data elements, and functions for example condition scenario.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/condition-example-functions.png)
...
1. Connect the source elements, functions, and target elements in the specific order as your scenario requires.
   ...
   ![Screenshot shows mapper surface, data elements, and functions with mappings for example condition scenario.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/condition-example-mappings.png)
...
1. In the following function details, on the **Input** tab, confirm or provide the following values:
   ...
   ![Screenshot shows finished condition example.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/condition-example-complete.png)

   The **Code** pane shows the mapping that you created:

   ![Screenshot shows Code pane  with conditional mapping between source and target elements using the functions, Greater, Multiply, and If.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/condition-example-code-view.png)
...
1. Open the **Map Name** list, and select your map (.xslt file).
   ...
   ![Screenshot shows Visual Studio Code, Standard workflow designer, with selected action named Transform using Data Mapper XSLT and action properties.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/transform-data-mapper-xslt-action.png)
...
1. Put or move the XSLT snippet file into the following project folder:
   ...
   **Artifacts** > **DataMapper\Extensions** > **InlineXSLT**
   ...
   ![Screenshot shows Visual Studio Code, Standard logic app project, and InlineXslt project folder with InlineXslt.xsd file.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/inline-xslt-project-structure.png)
...
1. From the **File** dropdown list, select the executable **.xslt** file that you added to the **InlineXSLT** folder, for example:
   ...
   ![Screenshot shows opened data mapper surface and Run XSLT function with selected InlineXslt.xsd file.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/run-xslt.png)

1. Connect the **Run XSLT** function to the destination node where you want to apply the XSLT logic, for example:

   ![Screenshot shows opened data mapper surface and Run XSLT function connected to destination node.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/run-xslt-destination.png)
...
1. In the **XPATH expression** box, enter an expression that performs the work you want.
   ...
   ![Screenshot shows opened data mapper surface and Execute XPath function with expression.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/execute-xpath.png)
...
1. Connect the **Execute XPath** function to the destination node where you want to run the function.
   ...
   ![Screenshot shows opened data mapper surface and Execute XPath function connected to destination node.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/execute-xpath-destination.png)
...
1. Test your map to confirm that the expected results appear in the destination schema.
   ...
   ![Screenshot shows opened data mapper surface, Execute XPath function, and test results in destination schema.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/execute-xpath-results.png)
...
1. Connect the function to the required endpoints.
   ...
   ![Screenshot shows opened data mapper surface and custom function named Age.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/custom-function-age.png)

1. Test your map to confirm that the expected results appear in the destination schema, for example:

   ![Screenshot shows opened data mapper surface, custom function named Age, and function results.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/media/create-maps-data-transformation-visual-studio-code/custom-function-age-results.png)
...
- [Add maps for transformations in workflows with Azure Logic Apps](https://learn.microsoft.com/en-us/azure/logic-apps/logic-apps-enterprise-integration-maps)
