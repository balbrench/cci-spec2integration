<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine/create-rules -->
...
- *Vocabulary*: A friendly name for facts used in conditions and actions. For more information, see [Create and manage vocabularies](https://learn.microsoft.com/en-us/azure/logic-apps/create-manage-vocabularies).

The following diagram and sections describe how conditions, actions, and facts, fit together:

![Conceptual diagram shows the Microsoft Rules Engine.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/rules-engine/media/create-rules/rules-definition.png)
...
![Conceptual diagram shows the Microsoft Rules Composer.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/rules-engine/media/create-rules/composer-main.png)
...
| **Fact Retriever** | The fact retriever to use for supplying facts to the ruleset version. <br><br>The Microsoft Rules Composer supports the capability build and use a fact retriever to supply facts. For more information, see the following documentation: <br><br>- [Perform advanced tasks on rulesets](https://learn.microsoft.com/en-us/azure/logic-apps/perform-advanced-ruleset-tasks#set-up-fact-retriever) <br>- [Build fact creators and retrievers](https://learn.microsoft.com/en-us/azure/logic-apps/build-fact-creators-retrievers) |
...
For more information on working with rulesets, see [Perform advanced tasks on rulesets](https://learn.microsoft.com/en-us/azure/logic-apps/perform-advanced-ruleset-tasks).
...
| **Priority** | The priority for the rule within the ruleset. The higher the index, the higher the rule priority. The actions for a higher priority rule run first. <br><br>The default value is 0 and represents middle priority. You can make the value positive or negative. For more information, see [Rules engine optimization](https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine-optimization). |
...
1. In the **IF** window, which is the conditions editor, open the **Conditions** shortcut menu, and choose one of the following:
   ...
   - Select a logical operator. From the operator's shortcut menu, add the predicates or nested logical operators that you want to evaluate.
     ...
     For more information about setting up logical operators, see [Add arithmetic and logic operators to rules](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-operators#add-logical-operator)
...
1. In the **THEN** window, which is the actions editor, open the **Actions** shortcut menu, and select a built-in function to add an action and argument.
   ...
   | **Clear** | Reset the working memory and agenda of the rules engine instance. For more information about working memory and agenda, see [Rules engine optimization](https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine-optimization). |
...
For more information, see [Optimize rules with control functions](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-control-functions).
...
The actions in a rule execute based on the specified order except for the [rules engine control functions](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-control-functions), which execute following other actions.
...
- To add an arithmetic or logical operator to an argument, see [Add arithmetic and logical operators to rules](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-operators).
...
1. Find and open the .NET assembly that you want to use.
   ...
   ![Screenshot shows the Microsoft Rules Composer with the Facts Explorer, classes, and class members.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/rules-engine/media/create-rules/facts-explorer-net.png)
...
1. In the **Schema Files** box, find and select the XML schema (.xsd) file, and select **Open**.
   ...
   ![Screenshot shows the Microsoft Rules Composer, Facts Explorer, and XML elements.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/rules-engine/media/create-rules/facts-explorer-xml.png)
...
![Screenshot shows the Microsoft Rules Composer, Facts Explorer, XML elements, and their attributes.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/rules-engine/media/create-rules/xml-facts-example.png)
...
- [Add arithmetic and logical operators to rules](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-operators)
- [Add control functions to actions for optimizing rules execution](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-control-functions)
- [Perform advanced tasks on rulesets](https://learn.microsoft.com/en-us/azure/logic-apps/perform-advanced-ruleset-tasks)
- [Test your rulesets](https://learn.microsoft.com/en-us/azure/logic-apps/test-rulesets)
- [Create an Azure Logic Apps Rules Engine project](https://learn.microsoft.com/en-us/azure/logic-apps/create-rules-engine-project)
