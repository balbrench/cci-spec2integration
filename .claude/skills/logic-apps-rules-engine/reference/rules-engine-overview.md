<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine/rules-engine-overview -->
...
![Conceptual diagram shows the Azure Logic Apps Rules Engine.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/rules-engine/media/rules-engine-overview/rules-engine.png)

For more information on how to configure a Standard logic app resource with a Rules Engine project, see [Create an Azure Logic Apps Rules Engine project](https://learn.microsoft.com/en-us/azure/logic-apps/create-rules-engine-project).
