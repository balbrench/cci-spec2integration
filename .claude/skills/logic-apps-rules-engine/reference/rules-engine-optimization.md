<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine/rules-engine-optimization -->
...
The rules engine treats the actions in a rule as a block, so all actions run before the engine moves to the next rule. All actions in a rule block execute regardless of other actions in the block. For more information about assertion, see [Optimize your rules engine with control functions](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-control-functions).
...
For more information, see [Create rules using Microsoft Rules Composer](https://learn.microsoft.com/en-us/azure/logic-apps/create-rules#set-rule-priority).

### Logical OR operators

The rules engine is optimized to execute [logical **AND** operators](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-operators) and reconstructs the rule that the engine parsed into a [disjunctive normal form](https://mathworld.wolfram.com/DisjunctiveNormalForm.html) so that the [logical **OR** operator](https://learn.microsoft.com/en-us/azure/logic-apps/add-rules-operators) is used only at the top level.
...
- [What is the Azure Logic Apps Rules Engine](https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine-overview)?
