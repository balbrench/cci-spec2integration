<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine/perform-advanced-ruleset-tasks -->
...
1. Open the ruleset's shortcut menu, and select **Paste RuleSet Version**.
   ...
   > For more information, see [Update .NET assembly references](https://learn.microsoft.com/en-us/azure/logic-apps/create-rules#update-assembly-references).
...
When you use a fact retriever with your ruleset, you can store facts that don't often change so that before your host application's first execution cycle. That way, you can retrieve these facts from storage, present them once to the rules engine for caching, and reuse them over multiple execution cycles. For more information, see [Build fact creators and retrievers](https://learn.microsoft.com/en-us/azure/logic-apps/build-fact-creators-retrievers).
