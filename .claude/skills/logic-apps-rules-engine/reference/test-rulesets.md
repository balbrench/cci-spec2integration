<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/rules-engine/test-rulesets -->
...
- The XML file that contains the ruleset that you want to work on and the facts that you want to test.
  ...
  To add facts, specify their values in the XML files that you reference from the **Select Facts** window that opens after you select **Test Ruleset** in the following steps. You might want to build a fact creator to add .NET facts. For more information, see [Build fact creators and retrievers](https://learn.microsoft.com/en-us/azure/logic-apps/build-fact-creators-retrievers).
