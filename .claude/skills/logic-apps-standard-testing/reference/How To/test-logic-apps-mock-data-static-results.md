<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/testing-framework/test-logic-apps-mock-data-static-results -->
<!-- Title: Test workflows with mock outputs -->

# Test workflows with mock outputs in Azure Logic Apps

[!INCLUDE [logic-apps-sku-consumption-standard](https://learn.microsoft.com/en-us/azure/../../includes/logic-apps-sku-consumption-standard)]
...
* The logic app resource and workflow where you want to set up mock outputs. This article uses a **Recurrence** trigger and **HTTP** action as an example workflow.
  ...
  * [Quickstart: Create an example Consumption logic app workflow using the Azure portal](https://learn.microsoft.com/en-us/azure/quickstart-create-example-consumption-workflow)

  * [Create an example Standard logic app workflow using the Azure portal](https://learn.microsoft.com/en-us/azure/create-single-tenant-workflows-azure-portal)
...
- No indications exist at the logic app level that this capability is enabled. The following list describes where you can find indications that this capability is enabled:
  ...
  - On the action shape, the lower-right corner shows the test beaker icon (![Icon for static result](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/static-result-test-beaker-icon.png)).
...
1. On the action information pane, select **Testing**, for example:
   ...
   ![Screenshot shows the Azure portal, Consumption workflow designer, HTTP action information pane, and Testing selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/select-testing.png)
...
1. From the **Select Fields** list, select the properties where you want to specify mock outputs to return in the action's response.
   ...
   ![Screenshot shows Consumption workflow and Testing pane after selecting Enable Static Result with the Status and Error fields also selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/enable-static-result.png)

1. When you're ready, select **Save**.

   The action's lower-right corner now shows a test beaker icon (![Icon for static result](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/static-result-test-beaker-icon.png)), which indicates that you enabled static results.

   ![Screenshot shows Consumption workflow with HTTP action and static result icon.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/static-result-enabled.png)
...
1. On the action information pane, select **Testing**, for example:
   ...
   ![Screenshot shows Standard workflow with HTTP action details pane, and Testing selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/select-testing-standard.png)
...
1. From the **Select Fields** list, select the properties where you want to specify mock outputs to return in the action's response.
   ...
   ![Screenshot shows Standard workflow and Testing pane after selecting Enable Static Result with the Status and Error fields also selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/enable-static-result-standard.png)

1. When you're ready, select **Save**.

   The action's lower-right corner now shows a test beaker icon (![Icon for static result](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/static-result-test-beaker-icon.png)), which indicates that you enabled static results.

   ![Screenshot shows Standard workflow with HTTP action and static result icon.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/static-result-enabled.png)
...
1. In the **Runs history** table, find the **Static Results** column.
   ...
   ![Screenshot shows Consumption workflow run history with the Static Results column.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/run-history.png)

1. To view the actions in a run that uses mock outputs, select the run where the **Static Results** column is set to **Enabled**.

   In the workflow run details pane, actions that use static results show the test beaker icon (![Icon for static result](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/static-result-test-beaker-icon.png)), for example:

   ![Screenshot shows Consumption workflow run history with actions that use static results.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/run-history-static-result.png)
...
1. Select **Disable Static Result** > **Save**.
   ...
   ![Screenshot shows logic app workflow, HTTP action, and Testing tab with Disable Static Result selected.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/test-logic-apps-mock-data-static-results/disable-static-result.png)

## Reference

For more information about this setting in your underlying workflow definitions, see [Static results - Schema reference for Workflow Definition Language](https://learn.microsoft.com/en-us/azure/logic-apps-workflow-definition-language.md#static-results) and [runtimeConfiguration.staticResult - Runtime configuration settings](https://learn.microsoft.com/en-us/azure/logic-apps-workflow-actions-triggers.md#runtime-configuration-settings).

## Related content

* [What is Azure Logic Apps?](https://learn.microsoft.com/en-us/azure/logic-apps-overview)
