<!-- Source: https://learn.microsoft.com/en-us/azure/logic-apps/testing-framework/create-unit-tests-standard-workflow-runs-visual-studio-code -->
...
- A Standard logic app project in Visual Studio Code that contains at least one previously and locally executed workflow to use for creating a unit test.
  ...
  For more information about Visual Studio Code setup and project creation, see [Create Standard logic app workflows with Visual Studio Code](https://learn.microsoft.com/en-us/azure/logic-apps/create-standard-workflows-visual-studio-code).
...
1. On the overview page, under **Run history**, select the workflow run to use for creating a unit test.
   ...
   ![Screenshot shows Visual Studio Code with Standard logic app project, debug mode running, opened workflow overview page, and selected workflow run.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/create-unit-tests-standard-workflow-runs-visual-studio-code/overview-page.png)

1. On the run history toolbar, select **Create unit test from run**.

   ![Screenshot shows Visual Studio Code, Standard workflow run history page, and selected command to creat unit test.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/create-unit-tests-standard-workflow-runs-visual-studio-code/run-history-page.png)
...
1. Provide a name to use for the unit test, unit test class, and C# file.
   ...
   ![Screenshot shows Visual Studio Code, Standard logic app project, and Tests folder with unit test folders and files.](https://raw.githubusercontent.com/MicrosoftDocs/azure-docs/main/articles/logic-apps/testing-framework/media/create-unit-tests-standard-workflow-runs-visual-studio-code/unit-test-project-structure.png)
